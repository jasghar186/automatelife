...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header container-fluid">
		<div class="row header-main">
			...
			<div class="header-ctas col-7 d-flex align-items-center justify-content-end">
				...
				<a type="button" class="header-cta-button text-decoration-none text-uppercase bg-primary py-1 px-3 text-white text-center fw-bold">shop <img src="<?php echo esc_url(site_url()); ?>/wp-content/themes/automate-life/assets/images/header-shop-icon.svg" /></a>
			</div>
		</div>

		<div class="header-bottom d-flex align-items-center mt-3 gap-4 pb-3 border-bottom border-dark">
			...
			<!-- Get the search form -->
			<?php 
				if((int)get_option('enable-search-bar')) {
